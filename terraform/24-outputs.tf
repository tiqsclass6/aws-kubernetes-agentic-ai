...
output "agent_topics" {
  description = "Pub/Sub topics used by the Phase 5 multi-agent workflow"
  value = {
...
output "agent_subscriptions" {
  description = "Pull subscriptions used by each Phase 5 workflow stage"
  value = {
...
output "phase5_approval_key_version" {
  description = "Cloud KMS key version used to sign and verify human approval decisions"
  value       = local.phase5_approval_key_version_name
}

output "phase5_evidence_dataset" {
  description = "BigQuery dataset receiving Phase 5 governance evidence logs"
  value       = google_bigquery_dataset.governance_evidence.dataset_id
}

output "phase5_policy_id" {
  description = "Governance policy identifier expected by the executor"
  value       = var.phase5_policy_id
}
