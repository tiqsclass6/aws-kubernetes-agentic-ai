...
# Normalized findings consumed by the Phase 3 multi-agent workflow.
...
# A pull subscription makes lab validation deterministic. Phase 3 will add dedicated agent subscriptions without changing this topic.
